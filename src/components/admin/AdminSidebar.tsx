...
import {
  ...
  LogOut, ArrowLeft, Camera, Ticket, X, ClipboardList, Menu, Award, ClipboardCheck, Gamepad2
} from "lucide-react";

import { UserRole } from "@/hooks/use-auth";

export type Tab = "dashboard" | "categories" | "courses" | "schedules" | "materials" | "exams" | "absensi" | "events" | "gallery" | "announcements" | "users" | "results" | "mini_games";
...
const allTabs = [
  ...
  { id: "mini_games", label: "Mini Games", icon: Gamepad2, roles: ["super_admin", "mentor"] },
